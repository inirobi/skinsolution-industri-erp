...
<div class="page-title">
  <div class="title_left">
    <h3>Purchase Order Product List</h3>
  </div>
      ...
      <div style='float:right'>
        <div class="input-group">
          <ul class="breadcrumb">
            ...
            <li><a>Purchase Order Products</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
          <a data-toggle="modal" href="#modalAdd" class="btn btn-success" ><i class="fa fa-plus"></i> Add New PO Product </a>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <div class="row">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="col-md-12 xdisplay_inputx form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="single_cal2" value="" placeholder="Date" aria-describedby="date" name='date' required>
          ...
          <div class="form-group">
            <fieldset>
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="col-md-12 xdisplay_inputx form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="single_cal1" placeholder="Date" aria-describedby="date" name='date_end' required>
                    <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                  </div>
                </div>
              </div>
...
<div class="modal fade bd-example-modal-lg" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalAddLabel">Add New PO Product</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="{{ route('po_product_pemesanan.store') }}" role="form" method="post">
          {{csrf_field()}}
          <div class="form-group">
            <label class="control-label col-md-2">Po Number</label>
...
function editConfirm(id,po_num,customer_id,date)
{
    $('#po_num').attr('value',po_num);
    $('#single_cal2').attr('value',date);
    $('#customer_id').val(customer_id);
    $('#editPennjualan').attr('action',"{{ url('po_product_pemesanan') }}/"+id)
    $('#modalUpdate').modal();
}
