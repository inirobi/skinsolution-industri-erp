        ...
        @foreach($product as $data)
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input class="form-control @error('product_code') is-invalid @enderror" disabled value="{{ old('product_code', $data->product_code ?? '') }}" name="product_code" required="required" />
            </div>
            @error('product_code')
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input class="form-control @error('product_name') is-invalid @enderror" disabled value="{{ old('product_name', $data->product_name ?? '') }}" name="product_name" required="required" />
            </div>
            @error('product_name')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <select class="form-control" disabled name="customer_id">
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <select disabled class="form-control" name="formula_id">
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
            <select disabled class="form-control" name="trial_revision_data_id">
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <textarea class="form-control" disabled name="description" rows="3">{{ old('description', $data->description ?? '') }}</textarea>
            </div>
          </div>
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input class="form-control @error('sale_price') is-invalid @enderror" disabled value="{{ old('sale_price', $data->sale_price ?? '') }}" name="sale_price" required="required" />
            </div>
            @error('sale_price')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <select disabled class="form-control" name="packaging_id">
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
                <select disabled class="form-control" name="labelling_id">
                    <option value="0"></option>
