    ...
    <div style='float:right'>
      <div class="input-group">
        <ul class="breadcrumb">
          ...
          <li><a href="{{route('rnd.index')}}"></a>RnDs</li>
          <li>
            @if(isset($matout))
                {{ __('Update RnD') }}
            @else
...
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="x_panel">
      <div class="x_content">
        @if(isset($matout))
          <form action="{{ route('rnd.update', $matout) }}" novalidate method="POST" enctype="multipart/form-data">
          @method('PUT')
        @else
            <form action="{{ route('rnd.store') }}" method="POST" enctype="multipart/form-data">
        @endif
        ...
        @csrf
          ...
          @if(isset($matout))
              <a href="{{ route('rnd.index') }}" class="btn btn-danger">Cancel</a>
            @else
