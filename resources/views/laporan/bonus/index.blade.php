  ...
  <div class="col-md-12 col-sm-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <div class="row">
          <div class="col-sm-12">
            <form action="{{route('laporanBonus.store')}}" novalidate method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="x_panel">
      <div class="x_content">
          ...
          @php
            $bonus = ($tot1 - $tot2) * 0.01;
            $bonus = ($bonus<0) ? 0 : $bonus;
          @endphp
          <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align" style="font-size:14pt;"> <strong>Bonus :</strong> </label>
            <div class="col-md-6 col-sm-6">
              <label class="col-form-label" style="font-size:14pt;"><strong>Rp {{number_format($bonus,2)}}</strong></label>
              <input class="form-control" type="hidden" name="bonus" readonly value="Rp {{number_format($bonus,2)}}"/>
            </div>
          </div>
...
<div class="page-title">
  <div class="title_left">
    <h3 style="font-size:14pt">BONUS</h3><br><br><br>
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<th>Rp {{number_format($bonus,2)}}</th>
					</tr>
				</tbody>
			</table>
		</div>
