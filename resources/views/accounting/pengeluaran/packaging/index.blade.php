                ...
                <tbody>
                  ...
                  @foreach($purchase as $data)
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a class="btn btn-info" href="{{url('pengeluaran_packaging/view',$data->id)}}" title="Detail" class="btn btn-small text-primary">
                              <i class="fa fa-eye"></i>
                            </a>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('pengeluaran_packaging')}}" method="post">
          @method('PUT')
          @csrf
