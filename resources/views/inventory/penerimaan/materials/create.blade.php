...
<form action="{{route('purchases_material.store')}}" method="POST" enctype="multipart/form-data">
<div class="row">
        ...
        @csrf
          ...
          <div class="field item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input class="form-control" name="purchase_num" required="required" />
            </div>
          </div>
          <div class="field item form-group">
...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
        <button type='submit' class="btn btn-primary"><i class="fa fa-check"></i> Add Purchase</button>
...
    $.each(data, function(index, subcatObj){
      ...
      +'<div class="input-group expired_date date" ><input type="date" class="form-control" id="expired_date'+idx+'" name="expired_date[]" /><span class="input-group-addon"><span class="fa fa-calendar"></span></span></td><td>'
